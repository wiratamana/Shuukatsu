...
namespace Tamana.AI
{
    public class AI_Tough : AI_Brain
    {
        ...
        private readonly short[] defensiveMethods = { 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2 };
        ...
        public override void aiStart()
        {
            ...
            if(attackReader == null) attackReader = new ComponentAI_PlayerAttackReader(0.0f);
            ...
            else if (ai.distanceFromPlayer > 5.0f)
            {
               ...
               //}
                ...
                if (ai.distanceFromPlayer < 8.5f && attackReader.isPlayerBeginToAttack && !(ai.isTakingDamage || ai.isTakingDamageBIG) && isPlayerFacingMe)
                {
                    ...
                    else if (defensiveMethods[currenIndex] == 1)
                    { ai.aiBlock.StartBlocking(); isParryAndCounter = true; action = 0; }
                    else { if ((ai.isTakingDamageBIG || ai.isBlockImpactAIR)) ai.aiBlock.StartBlocking(); }
